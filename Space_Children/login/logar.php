      ...
      <ul>
        <li>
          ...
          <span class="login-info">
            <input type="text" placeholder="Insira seu email" class="login-input" name="email" autocomplete="off" required>
          </span>
          <span class="login-info">
            <input type="password" placeholder="Insira sua senha" class="login-input" name="senha" autocomplete="off" required>
          </span>
          <button class="btn-entrar"><b>Entrar</b></button>
